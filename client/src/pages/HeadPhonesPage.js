...
const HeadPhonesPage = () => {
  ...
  const headProducts = products.filter(
    (product) => product.name.split(" ").pop() === ("Computer" || "Keyboard" )
  //  const shirtProducts = products.filter((product) =>  product.name.split(" ").pop() === "Computer" || "Keyboard");
    ...
    <>
      ...
      <section className="py-5">
        <div className="container">
          <Title title="ELECTRONIC PRODUCTS" />
          <div className="row">
